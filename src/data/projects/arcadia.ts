...
export const arcadiaDetail: ProjectDetail = {
  ...
  meta: [
    ...
    { label: "Collaborating Lab", value: "南京艺术学院智能与超感观实验室" },
  ],
  lead: [
    "「桃源·幻境 ARCADIA」是一场结合机械装置、沉浸式空间与交互体验的新观念沉浸式艺术联展，作为南京艺术学院 520 毕业展演嘉年华的重要组成部分，创造性地在夫子庙 MO 音琵琶街、马群招商花园城、景枫 KINGMO 三地分三个篇章同时展出，运用新媒体的表现形式，探索数字时代的未来与中国传统文化之间的联系；通过营造出一个未来主义的古典幻境，引领观众经历一个由好奇到思考的探寻过程。在该项目中，本人负责交互技术支持与开发。",
  ],
  sections: [
    {
      type: "part",
